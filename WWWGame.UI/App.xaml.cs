    ...
    public partial class App : Application
    {
        ...
        public static MainViewModel ViewModel
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("ViewModel already set");
                }
            }
        }
        ...
        {
            Mapper.CreateMap<Tourn, Model.TournRow>()
                .ForMember(dest => dest.Type, opt => opt.MapFrom(src => src.HasChildTourns ? TournType.Tourn: TournType.SubLevel));
            Mapper.CreateMap<Tourn, Model.Tourn>();
            Mapper.CreateMap<LogicLayer.Model.Question, Model.Question>();
            Mapper.CreateMap<LogicLayer.Model.Image, Model.Image>();
        }
